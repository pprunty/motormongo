        ...
        if value is not None:
            if isinstance(value, (list, tuple)) and len(value) == 2:
                ...
                if not (-90 <= latitude <= 90) and (-180 <= longitude <= 180):
                    raise GeoCoordinateError("Latitude must be between -90 and 90, and Longitude must be between -180 and 180")
                ...
                raise GeoCoordinateError("Value must be a list or tuple of [latitude, longitude] or a GeoJSON dictionary")
